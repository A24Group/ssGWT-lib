...
public class DataGrid<T> extends AbstractCellTable<T> implements RequiresResize {
  ...
  public DataGrid(int pageSize, Resources resources, ProvidesKey<T> keyProvider,
    ...
    tableDataContainer.setId("tableDataContainer");
    ((CustomScrollPanel)tableDataScroller).removeHorizontalScrollbar();
    // This is added for debugging and styles
    tableDataScroller.getElement().setId("tableDataScroller");
    /*
