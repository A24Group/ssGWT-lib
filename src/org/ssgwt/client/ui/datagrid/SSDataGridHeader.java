...
/**
 * Displays a the column headers for a SSDataGrid
 * 
 * @author Johannes Gryffenberg
 * @since 27 June 2012
 */
public class SSDataGridHeader extends Composite {
     ...
     * @since 27 June 2012
     */
    interface Binder extends UiBinder<Widget, SSDataGridHeader> {}
