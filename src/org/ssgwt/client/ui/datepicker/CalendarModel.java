...
import org.ssgwt.client.i18n.DateTimeFormat.PredefinedFormat;
...
public class CalendarModel {
    ...
    private final SSDate currentMonth;

    /**
     * Constructor.
     */
    public CalendarModel() {
        currentMonth = new SSDate();
     ...
     */
    public String formatDayOfMonth(SSDate date) {
     ...
     */
    public SSDate getCurrentFirstDayOfFirstWeek() {
        ...
        if (wkDayOfMonth1st == start) {
            ...
            // display date
            return new SSDate(currentMonth.getTime());
        } else {
            SSDate d = new SSDate(currentMonth.getTime());
     ...
     * @return date
     */
    public boolean isInCurrentMonth(SSDate date) {
     ...
     */
    public void setCurrentMonth(SSDate currentDate) {
