...
public class DatePicker extends Composite implements
        HasHighlightHandlers<SSDate>, HasShowRangeHandlers<SSDate>, HasValue<SSDate>,
     ...
     */
    private static class DateHighlightEvent extends HighlightEvent<SSDate> {
        protected DateHighlightEvent(SSDate highlighted) {
            super(highlighted);
        }

        @Override
        public SSDate getHighlighted() {
    ...
    private static class DateStyler {
        ...
        public String getStyleName(SSDate d) {
            return info.get(genKey(d));
        }

        public void setStyleName(SSDate d, String styleName, boolean add) {
        ...
        private String genKey(SSDate d) {
    ...
    private SSDate value;
    private SSDate highlighted;
    ...
    protected DatePicker(MonthSelector monthSelector, CalendarView view,
        ...
        setCurrentMonth(new SSDate());
        addStyleToDates(css().dayIsToday(), new SSDate());
    }

    public HandlerRegistration addHighlightHandler(HighlightHandler<SSDate> handler) {
        return addHandler(handler, HighlightEvent.getType());
    }

    public HandlerRegistration addShowRangeHandler(ShowRangeHandler<SSDate> handler) {
    ...
    public HandlerRegistration addShowRangeHandlerAndFire(
            ShowRangeHandler<SSDate> handler) {
        ShowRangeEvent<SSDate> event = new ShowRangeEvent<SSDate>(
     ...
     */
    public void addStyleToDates(String styleName, SSDate date) {
     ...
     * Add a style name to the given dates.
     */
    public void addStyleToDates(String styleName, SSDate date, SSDate... moreDates) {
        addStyleToDates(styleName, date);
        for (SSDate d : moreDates) {
     ...
     * Add a style name to the given dates.
     */
    public void addStyleToDates(String styleName, Iterable<SSDate> dates) {
        for (SSDate d : dates) {
            addStyleToDates(styleName, d);
        }
    }
     ...
     */
    public void addTransientStyleToDates(String styleName, SSDate date) {
     ...
     * This is only set until the next time the DatePicker is refreshed.
     */
    public final void addTransientStyleToDates(String styleName, SSDate date,
            SSDate... moreDates) {
    ...
    public final SSDate getFirstDate() {
     ...
     */
    public final SSDate getHighlightedDate() {
    ...
    public final SSDate getLastDate() {
     ...
     */
    public String getStyleOfDate(SSDate date) {
     ...
     */
    public boolean isDateVisible(SSDate date) {
        CalendarView r = getView();
        SSDate first = r.getFirstDate();
        SSDate last = r.getLastDate();
     ...
     */
    public void removeStyleFromDates(String styleName, SSDate date) {
     ...
     * Removes the styleName from the given dates (even if it is transient).
     */
    public void removeStyleFromDates(String styleName, Iterable<SSDate> dates) {
        for (SSDate d : dates) {
            removeStyleFromDates(styleName, d);
        }
    }
     ...
     */
    public void setCurrentMonth(SSDate month) {
     ...
     */
    public final void setTransientEnabledOnDates(boolean enabled, SSDate date) {
        assert isDateVisible(date) : date + " must be visible";
     ...
     */
    public final void setValue(SSDate newValue) {
     ...
     */
    public final void setValue(SSDate newValue, boolean fireEvents) {
        SSDate oldValue = value;
     ...
     */
    void setHighlightedDate(SSDate highlighted) {
