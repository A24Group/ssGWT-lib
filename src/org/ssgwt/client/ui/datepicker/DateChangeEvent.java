 ...
 */
class DateChangeEvent extends ValueChangeEvent<SSDate> {
     ...
     */
    public static <S extends HasValueChangeHandlers<SSDate> & HasHandlers> void fireIfNotEqualDates(
            S source, SSDate oldValue, SSDate newValue) {
     ...
     */
    protected DateChangeEvent(SSDate value) {
