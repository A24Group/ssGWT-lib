 ...
 */
public abstract class DateInputField<T> extends DateBox implements InputField<T, SSDate> {
     ...
     */
    public DateInputField(SSDatePicker picker, SSDate date, Format format) {
     ...
     * @param required - The value from the object that should the displayed on the input field
     */
    public DateInputField(DatePicker picker, SSDate date, Format format, boolean required) {
        super(picker, date, format);
        setRequired(required);
    }
     ...
     */
    @Override
    public abstract SSDate getValue(T object);
     ...
     */
    @Override
    public abstract void setValue(T object, SSDate value);
