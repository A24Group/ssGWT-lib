 ...
 * @since 03 Dec 2012
 */
public abstract class DateLabel<T> extends Label implements InputField<T, SSDate>, HasValue<SSDate> {
     ...
     */
    @Override
    public SSDate getValue(T object) {
        return null;
    }
     ...
     */
    @Override
    public void setValue(T object, SSDate value) {
    }
