 ...
 * time.
 */
public interface SSTimeZoneConstants extends TimeZoneConstants {
  ...
  /*
   * Time zones added to match the PHP supported time zones are below this comment
   */
  ...
  String antarcticaSouthPole();

  String asiaHebron();

  String asiaHoChiMinh();

  String asiaKathmandu();

  String asiaKolkata();

  String atlanticFaroe();
