...
public class StringRegexValidator extends AbstractValidator implements
     ...
     * We allow a hyphen, apostrophe or space in the middle of the name.
    ...
    /**
     * The regular expression patterns string to be used to validate decimal numbers.
     */
    public static final String REGEX_FLOATINGPOINT_NUMBER_PATTERN = "(^[+-]?([0-9]*[.])?[0-9]+$)";
